...
try:
    connector = mc.connect(user='root', password='9808283763', host='localhost')
...
def open_connection():
    ...
    connector = mc.connect(user='root', password='9808283763', host='localhost', database='student_management_system')
    db_cursor = connector.cursor(prepared=True)
...
class MyLabel(Label):
    def __init__(self, window, **kwargs):
        super().__init__(window, **kwargs)
        self.config(anchor=E, bg='#DCDCDC')
...
class LoginPage(Frame):
    def __init__(self, parent, controller):
        ...
        image = ImageTk.PhotoImage(Image.open("//Users//aashmalama//Desktop//student.png"))
        lbl_image = MyLabel(self, image=image)
        lbl_image.image =image
        lbl_image.place(x=304, y=25)
        ...
        self.btn_forgot_password = MyButton(self, text="Forgot password?", fg='#4760EB', font='arial 12 underline',
                                            bg='#DCDCDC', command=lambda: self.control.show_frame(ForgotPassword))
        self.btn_login = MyButton(self, width=10, fg='blue', text="Login", bg='Red', font='arial 12 bold',
                                  command=self.login)
        self.btn_create_account = MyButton(self, text="Create a new account", bg='#DCDCDC', fg='#4760EB',
...
class CreateAccount(Frame):
    def __init__(self, parent, controller):
        ...
        self.combo_day = ttk.Combobox(self, state='readonly', width=3, font='arial 12')
        self.combo_day['values'] = tuple(i for i in range(1, 32))
        self.combo_day.current(self.dt.day - 1)
        self.combo_day.place(x=250, y=356)

        self.combo_month = ttk.Combobox(self, state='readonly', width=3, font='arial 12')
        ...
        self.combo_year = ttk.Combobox(self, state='readonly', width=6, font='arial 12')
        ...
        self.combo_degree = ttk.Combobox(self, state='readonly', width=22, font='arial 12')
        self.combo_degree['values'] = ('Computing', 'Ethical Hacking', 'Commerce', 'Medical IT', 'Doctor','Computer Science', 'Nurse')
        self.combo_degree.current(0)
        self.combo_degree.place(x=234, y=496)

        self.btn_back = MyButton(self, width=10, fg='blue', text="Back", bg='#4760EB', font='arial 12 bold',
                                 command=self.back)
        self.btn_back.place(x=235, y=555)

        self.btn_signup = MyButton(self, width=10, fg='blue', text="Sign Up", bg='#4760EB', font='arial 12 bold',
...
class User(Frame):
    def __init__(self, parent, controller):
        ...
        self.combo_search = ttk.Combobox(self, state='readonly',  width=12, font='arial 12')
        self.combo_search['values'] = ('Id', 'First Name', 'Last Name', 'Contact', 'Address', 'Date of Birth',
                                       'Gender', 'Degree')
        self.combo_search.current(0)

        self.combo_sort = ttk.Combobox(self, state='readonly', width=12, font='arial 12')
        ...
        self.combo_degree['values'] = ('Computing', 'Ethical Hacking', 'Commerce', 'Medical IT', 'Doctor',
        ...
        self.student_table = ttk.Treeview(show_frame, height=17, column=('id', 'f_name', 'l_name', 'contact', 'address','date_of_birth','gender', 'degree'),
